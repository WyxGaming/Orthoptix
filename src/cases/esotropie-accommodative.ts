...
export const esotropieAccommodative: CasClinique = {
  ...
  questions: [
    ...
    },
    {
      ...
      reponse: 'Mon père est électricien, ma mère secrétaire.',
      poids: -2,
      commentaire: 'Sans lien avec une esotropie accommodative.',
    },
    {
      id: 'dentiste',
      rubrique: 'anamnese',
      libelle: 'Quand êtes-vous allé chez le dentiste pour la dernière fois ?',
      reponse: 'L’an dernier, rien de particulier.',
      poids: -2,
      commentaire: 'Hors sujet pour un bilan orthoptique.',
    },
    {
      id: 'animal-compagnie',
      rubrique: 'anamnese',
      libelle: 'Avez-vous un animal de compagnie ?',
      reponse: 'Oui, un chien.',
      poids: -2,
      commentaire: 'Ne renseigne pas sur la déviation ni la correction optique.',
    },
    {
      id: 'reseaux-sociaux',
      rubrique: 'anamnese',
      libelle: 'Combien de temps passez-vous sur les réseaux sociaux par jour ?',
      reponse: 'Une ou deux heures, je dirais.',
      poids: -1,
      commentaire: 'Question lifestyle sans lien avec une esotropie partiellement accommodative.',
    },
    {
      id: 'derniere-prise-sang',
      rubrique: 'antecedents',
      libelle: 'Quand avez-vous fait votre dernière prise de sang ?',
      reponse: 'Il y a deux ans, pour un bilan de santé.',
      poids: -2,
      commentaire: 'Hors champ d’un bilan orthoptique fonctionnel.',
    },
    {
      id: 'couleur-yeux',
      rubrique: 'anamnese',
      libelle: 'De quelle couleur sont vos yeux ?',
      reponse: 'Verts.',
      poids: -2,
      commentaire: 'Donnée observable à l’examen, pas une question d’anamnèse pertinente.',
    },
    {
      id: 'vacances',
      rubrique: 'anamnese',
      libelle: 'Où partez-vous en vacances cet été ?',
      reponse: 'On n’a pas encore décidé.',
      poids: -2,
      commentaire: 'Sans rapport avec le strabisme.',
    },
  ],
