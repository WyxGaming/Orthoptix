...
export const esotropiePrecoce: CasClinique = {
  ...
  questions: [
    ...
    },
    {
      id: 'dentiste',
      rubrique: 'anamnese',
      libelle: 'Quand est-elle allée chez le dentiste pour la dernière fois ?',
      reponse: 'Il y a trois mois, pour un contrôle de routine.',
      poids: -2,
      commentaire: 'Sans lien avec le strabisme ni le pronostic sensoriel.',
    },
    {
      id: 'animal-compagnie',
      rubrique: 'anamnese',
      libelle: 'Avez-vous un animal de compagnie à la maison ?',
      reponse: 'Oui, un lapin.',
      poids: -2,
      commentaire: 'Hors sujet dans un bilan orthoptique pédiatrique.',
    },
    {
      id: 'maternelle',
      rubrique: 'anamnese',
      libelle: 'Dans quelle école ou crèche est-elle scolarisée ?',
      reponse: 'En maternelle petite section, à l’école du quartier.',
      poids: -1,
      commentaire: 'Le nom de l’établissement n’éclaire pas la déviation oculaire.',
    },
    {
      id: 'allergies-alimentaires',
      rubrique: 'antecedents',
      libelle: 'A-t-elle des allergies alimentaires connues ?',
      reponse: 'Non, aucune allergie signalée.',
      poids: -1,
      commentaire: 'Peu pertinent pour une esotropie précoce sans signe général associé.',
    },
    {
      id: 'heure-coucher',
      rubrique: 'anamnese',
      libelle: 'À quelle heure se couche-t-elle le soir ?',
      reponse: 'Vers 20 h 30.',
      poids: 0,
      commentaire: 'Question anecdotique sans conséquence sur le bilan.',
    },
    {
      id: 'couleur-preferée',
      rubrique: 'anamnese',
      libelle: 'Quelle est sa couleur préférée ?',
      reponse: 'Le rose.',
      poids: -2,
      commentaire: 'Sans rapport avec l’oculomotricité.',
    },
  ],
